...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/145436dd8dc78b9f44828.jpg"
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://telegra.ph/file/145436dd8dc78b9f44828.jpg", 
                             caption="**⚡𝐒𝐔𝐊𝐇𝐈 𝐌𝐔𝐒𝐈𝐂⚡ мυѕι¢\n ησω ▶️ ραυѕє∂ ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALL:
        await message.reply_text("**⚡𝐒𝐔𝐊𝐇𝐈 𝐌𝐔𝐒𝐈𝐂⚡ мυѕι¢ \n ησтнιηg ρℓαуιηg ...**")
    else:
